...
`].filter(ws).join(`
`)),a=uo(a),a=Zc(a,t),a=jc(a,t),o=uo(o),o=Zc(o,t),o=jc(o,t),a=$c(a),o=$c(o),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+f);const y=v+m+a,x=v+f+o,O=Yc(i,i.VERTEX_SHADER,y),w=Yc(i,i.FRAGMENT_SHADER,x);i.attachShader(g,O),i.attachShader(g,w),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function b(I){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(g).trim(),G=i.getShaderInfoLog(O).trim(),Z=i.getShaderInfoLog(w).trim();let j=!0,Y=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(j=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,O,w);else{const J=Kc(i,O,"vertex"),V=Kc(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
